<template>
  <div class="body">
    <div @scroll="onScrollChange" class="title">
      {{ title }}
    </div>
  ...
  <div v-if="feedContent" class="feed">事件生成者反馈:{{ feedContent }}</div>
  <div v-if="isEndTime == '进行中'" class="postComment">
    <textarea v-model="value" class="postText"></textarea>
